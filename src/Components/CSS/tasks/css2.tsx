...
export const Css2 = () => {
    return(
        <div className="css-task css2">
            ...
            <p>Используя спрайт по <Link to={cards} target="_blank" rel="noreferrer">ссылке</Link></p>
            <ul>
                <li>
            ...
            <p>Используя пример с нашего занятия и дополнительный материал <a href="https://drive.google.com/drive/folders/1JPRdME-MA8SIm3P6B7w_yR36ObYNKpO6?usp=sharing" target="_blank" rel="noreferrer">здесь</a>, сверстайте "резиновую" рамку всеми доступными 4-мя предложенными в примерах способами:</p>
            <ul>
                <li>
                    Мульти-фон для одного блока - 2 варианта в примерах: <br/>
                    - один в презентации;
                    - второй в <a href={"https://drive.google.com/file/d/1GcrQxy5y2iPTD1CHrOLj9A2ZhCqi8gEG/view?usp=sharing"} target="_blank" rel="noreferrer">архиве</a>
                </li>
                <li>Классический вариант - девятью вложенными друг в друга &lt;div&gt;</li>
                <li>С использованием стилевого свойства border-image, так же описанного в <a href="https://drive.google.com/file/d/1GcrQxy5y2iPTD1CHrOLj9A2ZhCqi8gEG/view?usp=sharing" target="_blank" rel="noreferrer">архиве</a></li>
            </ul>
            <hr/>
            <h2>Домашнее задание - дополнительное #2</h2>
            <p>Используя <a href="https://css-live.ru/articles-css/shpargalka-po-shpargalke-po-flexbox.html" target="_blank" rel="noreferrer">эту шпаргалку</a> сверстайте задание "Домашнее задание - базовое #3" полностью при помощи flex блоков</p>
        </div>
    )
}
